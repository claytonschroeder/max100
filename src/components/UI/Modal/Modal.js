        ...
        switch(title){
            case 'SMARTER':
                return(
                    <div style={{ display: 'flex' }}>
                        <div>
                        <p>In the ‘SMARTER’ approach, criteria weights are defined in two steps - first by RANKING the criteria and sub-criteria by importance, then by RATING their relative importance on a 0-100 scale. These rankings and ratings will be used to define your weights.</p>
            ...
            case 'Swing Weighting':
                return(
                    <div style={{ display: 'flex' }}>
                        <div>
                        <p>In the ‘Swing Weighting’ approach, criteria weights are defined in two steps - first by RANKING the criteria and sub-criteria by importance, then by RATING their relative importance on a 0-100 scale. These rankings and ratings will be used to define your weights.</p>
                        <p>Before starting, please review the criteria hierarchy in the figure to the right. You will be asked to rank and rate the importance of the sub-criteria and main criteria separately. Definitions for each criterion can be found in Table 1 in the accompanying ‘Case Study Narrative’ document.</p>
                        <p>You can come back to this figure any time by pressing the ‘Info’ button on each page.</p>
                        </div>
                        <div>
